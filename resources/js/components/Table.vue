        ...
        <tbody>
            ...
            <tr v-for="obj, chave in dadosFiltrados" :key="chave">
                ...
                <td v-if="visualizar.visivel || atualizar || remover">
                     <button v-if="visualizar.visivel" class="btn btn-outline-primary btn-sm" :data-toggle="visualizar.dataToggle" :data-target="visualizar.dataTarget">Visualziar</button>
